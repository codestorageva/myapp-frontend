...
const PersonalDetails: FC<any> = ({ values, handleChange, handleBlur, industries, setFieldValue, companyLogo}) => {
    return (
        <div className='w-full mb-3'>
            <div className='mt-5 grid grid-cols-3 gap-x-4 gap-y-3'>
                <div className="sm:col-span-1">
                ...
                <div className="sm:col-span-1">
                    <CustomLabel title='Organization Logo' />
                    <div className="mt-1">
                        ...
                        <input type="file"  name='logo' autoComplete="given-name" accept="image/*" onChange={(event)=>{
                            const file = event.currentTarget.files?.[0];
                            if (file) {
                              setFieldValue('logo', file); // ✅ store File object
                            }
                        }} onBlur={handleBlur} className="block w-full font-inter rounded-md border focus:outline-none border-gray-300 py-1 px-2 text-gray-900 focus:border-blue-500 focus:border-[2px] placeholder:text-gray-400 sm:text-sm sm:leading-6" />
                        {companyLogo !== '' && <Link href={companyLogo} className='text-sm text-danger underline'>Click Here</Link> } 
                ...
                <div className="sm:col-span-1">
                    <CustomLabel title='GST Number' />
                    <div className="mt-1">
                        <input type="text"   name="gstNo" autoComplete="given-name" value={values.gstNo} onChange={handleChange} onBlur={handleBlur} className="block w-full font-inter rounded-md border focus:outline-none border-gray-300 py-1 px-2 text-gray-900 focus:border-blue-500 focus:border-[2px] placeholder:text-gray-400 sm:text-sm sm:leading-6" />
